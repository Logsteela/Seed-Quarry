...
CUPATH              = $$PWD/cubiomes
CUARCHIVER          =
macx: CUARCHIVER    = AR=\"/usr/bin/libtool\" ARFLAGS=\"-static -o\"
QMAKE_PRE_LINK      += $(MAKE) -C $$shell_quote($$CUPATH) -f $$shell_quote($$CUPATH/makefile) CC=\"$$QMAKE_CC\" CFLAGS=\"$(CFLAGS) $$QMAKE_CFLAGS\" $$CUARCHIVER $$CUTARGET
